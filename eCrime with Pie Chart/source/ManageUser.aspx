		...
		<div id="content">
		    ...
		    <div id="contenttext">
			    <div class="panel">
				    ...
				    <span class="orangetitle">Manage User:</span><span id="lblNewDept" runat="server" class="lbl" style="padding-left:160px;">Click <a class="gridlink" href="UserRegistration.aspx?type=dept&tag=new&id=0">here</a> to create user for Department</span><br /><br />
