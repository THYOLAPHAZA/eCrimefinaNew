<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageCriminalData.aspx.cs" Inherits="ManageCriminalData" %>
		...
		<div id="content">
		    ...
		    <div id="contenttext">
			    <div class="panel">
				    ...
				    <span class="orangetitle">Manage Criminal Data:</span><span class="lbl" style="padding-left:120px;">Click <a class="gridlink" href="ManageCriminalDataEdit.aspx?tag=new&id=0">here</a> to add new Criminal Data</span><br /><br />
