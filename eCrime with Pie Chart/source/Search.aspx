		...
		<div id="content">
		    ...
		    <div id="contenttext">
			    <div class="panel">
				    ...
				    <span class="orangetitle">Search Complaint:</span><br /><br />
                        <div style="padding-left:50px;">
			                <table>
			                    <tr>
			                        <td style="text-align:left"><span class="lbl">Complaint Type :</span></td>
			                        <td style="text-align:left"><asp:DropDownList ID="ddlFirType" runat="server" CssClass="ddllist">
                                            <asp:ListItem>-- Select --</asp:ListItem>
                                            <asp:ListItem>Complaint</asp:ListItem>
                                            <asp:ListItem>Missing Citizen</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlFirType" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
			                    </tr>
			                    <tr>
			                        <td style="text-align:left"><span class="lbl">Complaint No. :</span></td>
			                        <td style="text-align:left"><asp:TextBox ID="txtComplaintNo" runat="server" CssClass="txtBox" Text=""></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtComplaintNo" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
    			                </tr>
			                    <tr>
