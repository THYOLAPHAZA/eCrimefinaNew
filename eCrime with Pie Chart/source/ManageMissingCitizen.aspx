<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageMissingCitizen.aspx.cs" Inherits="ManageMissingCitizen" %>
		...
		<div id="content">
		    ...
		    <div id="contenttext">
			    <div class="panel">
				    ...
				    <span class="orangetitle">Manage Missing Citizen:</span><span class="lbl" style="padding-left:120px;">Click <a class="gridlink" href="LogMissing.aspx?type=dept&tag=new&mid=0" id="lnkAddnew" runat="server">here</a> to add Found Citizen</span><br /><br />
