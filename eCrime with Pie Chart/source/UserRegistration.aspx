		    ...
		    <div id="contenttext">
			    <div class="panel">
				    <div style="float:left;">
				        <span id="lblHead" runat="server" class="orangetitle">User Registration:</span><span id="lblUserId" runat="server" visible="false"></span><span id="lblUserType" runat="server" visible="false"></span><br /><br />
				        <div style="padding-left:50px;">
			                <table width="100%">
			                    <tr>
			                        ...
			                        <td style="text-align:left; width: 80px;" rowspan="3"><div style="border:solid 1px DarkGray; padding:5px; Height:75px; Width:75px;"><asp:Image ID="imgPhoto" runat="server" Height="75px" Width="75px" ImageUrl="~/photos/nopic.jpg" /></div></td>
    			                </tr>
			                    <tr>
			                    ...
			                    <tr>
			                        ...
			                        <td style="text-align:left" colspan="2"><asp:TextBox ID="txtEmailId" runat="server" CssClass="txtBox" Text=""></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtEmailId" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmailId"
                                ...
                                <tr>
                                    <td style="text-align: left"><span class="lbl">Location :</span></td>
                                    <td colspan="2" style="text-align: left">
                                        <asp:DropDownList ID="ddlLocation" runat="server" CssClass="ddllist" >
