...
public partial class ViewStatus : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            StrSql = "select * from FirLogDetails where EntryById = " + Class1.iUserId() + " and LID = " + Convert.ToInt16(txtComplaintNo.Text.ToString());
            Str = "ComplaintFir.aspx?tag=view&fid=0&lid=" + txtComplaintNo.Text.ToString();
        }
        else
        {
            StrSql = "select * from MissingCitizenMaster where CreatedById = " + Class1.iUserId() + " and MID = " + Convert.ToInt16(txtComplaintNo.Text.ToString());
