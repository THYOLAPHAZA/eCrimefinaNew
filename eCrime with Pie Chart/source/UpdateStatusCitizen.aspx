<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateStatusCitizen.aspx.cs" Inherits="UpdateStatusCitizen" %>
				    ...
				    <div style="float:left;">
				        ...
				        <div style="padding-left:50px;">
			                <table width="100%">
			                    ...
			                    <tr>
			                        <td style="text-align:left; width: 125px;"><span class="lbl">Status :</span></td>
			                        <td style="text-align:left">
			                    ...
			                    <tr id="trCloseFir" runat="server" visible="false">
			                        <td style="text-align:left; border-bottom:solid 1px #FF9900;" colspan="3"><span id="lblCriminalId" runat="server" visible="false"></span>
			                            <table>
			                                <tr>
			                                    <td style="text-align:left; width: 121px;"><span class="lbl">Criminal :</span></td>
                                                ...
                                                <td rowspan="4" style="text-align: left; padding-left:25px;">
                                                    <div style="border:solid 1px DarkGray; padding:5px;"><asp:Image ID="imgFCPhoto" runat="server" Height="75px" Width="75px" ImageUrl="~/photos/nopic.jpg" /><span id="lblPhotoName" runat ="server" visible="false"></span></div>
                                                </td>
			                                </tr>
			                                <tr>
