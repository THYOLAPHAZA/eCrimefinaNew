<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageCriminalDataEdit.aspx.cs" Inherits="ManageCriminalDataEdit" %>
		    ...
		    <div id="contenttext">
			    <div class="panel">
				    <div style="float:left;">
				        <span class="orangetitle">Criminal Details:</span><span id="lblId" runat="server" visible="false"></span><br /><br />
				        <div style="padding-left:50px;">
			                <table>
			                    <tr>
			                        ...
			                        <td style="text-align:left; width: 80px; padding-left:20px;" rowspan="3"><div style="border:solid 1px DarkGray; padding:5px;"><asp:Image ID="imgPhoto" runat="server" Height="75px" Width="75px" ImageUrl="~/photos/nopic.jpg" /></div></td>
    			                </tr>
			                    <tr>
			                    ...
			                    <tr>
			                        ...
			                        <td style="text-align:left; width: 80px; padding-left:20px;">
			                    ...
			                    <tr>
			                        ...
			                        <td style="text-align:left"><asp:TextBox ID="txtMobileNo" runat="server" CssClass="txtBox" Text=""></asp:TextBox></td>
			                    ...
			                    <tr>
			                        <td style="text-align:left; border-bottom:solid 1px #FF9900;"><span class="lbl">Address :</span></td>
			                        <td style="text-align:left; border-bottom:solid 1px #FF9900;"><asp:TextBox ID="txtAddress" runat="server" CssClass="txtBox" Text=""></asp:TextBox></td>
			                        <td style="text-align:left; border-bottom:solid 1px #FF9900; width: 80px;">&nbsp;</td>
    			                </tr>
                                <tr>
			                    ...
			                    <tr>
			                        <td style="text-align:left; padding-top:25px;">&nbsp;</td>
